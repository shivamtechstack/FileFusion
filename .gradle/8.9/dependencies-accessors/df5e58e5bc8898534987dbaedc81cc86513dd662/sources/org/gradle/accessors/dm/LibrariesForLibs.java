...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndrognitoLibraryAccessors extends SubDependencyFactory {
        private final AndrognitoPatternlockviewLibraryAccessors laccForAndrognitoPatternlockviewLibraryAccessors = new AndrognitoPatternlockviewLibraryAccessors(owner);

        public AndrognitoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>andrognito.patternlockview</b>
         */
        public AndrognitoPatternlockviewLibraryAccessors getPatternlockview() {
            return laccForAndrognitoPatternlockviewLibraryAccessors;
        }

    }

    public static class AndrognitoPatternlockviewLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndrognitoPatternlockviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>reactive</b> with <b>com.andrognito.patternlockview:patternlockview-reactive</b> coordinates and
         * with version reference <b>patternlockviewReactive</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getReactive() {
            return create("andrognito.patternlockview.reactive");
        }

    }

    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidMavenLibraryAccessors laccForAndroidMavenLibraryAccessors = new AndroidMavenLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.maven</b>
         */
        public AndroidMavenLibraryAccessors getMaven() {
            return laccForAndroidMavenLibraryAccessors;
        }

    }

    public static class AndroidMavenLibraryAccessors extends SubDependencyFactory {
        private final AndroidMavenGradleLibraryAccessors laccForAndroidMavenGradleLibraryAccessors = new AndroidMavenGradleLibraryAccessors(owner);

        public AndroidMavenLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.maven.gradle</b>
         */
        public AndroidMavenGradleLibraryAccessors getGradle() {
            return laccForAndroidMavenGradleLibraryAccessors;
        }

    }

    public static class AndroidMavenGradleLibraryAccessors extends SubDependencyFactory {

        public AndroidMavenGradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>plugin</b> with <b>com.github.dcendents:android-maven-gradle-plugin</b> coordinates and
         * with version reference <b>androidMavenGradlePlugin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            return create("android.maven.gradle.plugin");
        }
    ...
    public static class GradleLibraryAccessors extends SubDependencyFactory {
        private final GradleBintrayLibraryAccessors laccForGradleBintrayLibraryAccessors = new GradleBintrayLibraryAccessors(owner);

        public GradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>gradle.bintray</b>
         */
        public GradleBintrayLibraryAccessors getBintray() {
            return laccForGradleBintrayLibraryAccessors;
        }

    }

    public static class GradleBintrayLibraryAccessors extends SubDependencyFactory {

        public GradleBintrayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>plugin</b> with <b>com.jfrog.bintray.gradle:gradle-bintray-plugin</b> coordinates and
         * with version reference <b>gradleBintrayPlugin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            return create("gradle.bintray.plugin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidMavenGradlePlugin</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidMavenGradlePlugin() { return getVersion("androidMavenGradlePlugin"); }
        ...
        /**
         * Version alias <b>gradleBintrayPlugin</b> with value <b>1.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGradleBintrayPlugin() { return getVersion("gradleBintrayPlugin"); }
        ...
        /**
         * Version alias <b>patternlockviewReactive</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPatternlockviewReactive() { return getVersion("patternlockviewReactive"); }
